...
export const objectWithForms = (values: (Form | null)[] | null): number => sn.objectWithForms(values)
...
export const writeToFormPArray = (object: number, targetArray: (Form | null)[] | null, writeAtIdx: number = 0, stopWriteAtIdx: number = -1, readIdx: number = 0, defaultValRead: Form | null = null): boolean => sn.writeToFormPArray(object, targetArray, writeAtIdx, stopWriteAtIdx, readIdx, defaultValRead)
