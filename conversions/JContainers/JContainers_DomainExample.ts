...
export const JArray_writeToFormPArray = (object: number, targetArray: Form[], writeAtIdx: number = 0, stopWriteAtIdx: number = -1, readIdx: number = 0, defaultValRead: Form | null = null): boolean => sn.JArray_writeToFormPArray(object,  targetArray,  writeAtIdx,  stopWriteAtIdx,  readIdx,  defaultValRead)
