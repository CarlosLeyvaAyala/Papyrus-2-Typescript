...
export const GetActiveEffects = (akActor: Actor | null | undefined, abShowInactive: boolean = false): MagicEffect | null | undefined => sn.GetActiveEffects(akActor,  abShowInactive)
...
export const GetCombatAllies = (akActor: Actor | null | undefined): Actor | null | undefined => sn.GetCombatAllies(akActor)

	//Gets all targets of the actor, if in combat
export const GetCombatTargets = (akActor: Actor | null | undefined): Actor | null | undefined => sn.GetCombatTargets(akActor)
...
export const AddAllEquippedItemsToArray = (akActor: Actor | null | undefined): Form | null | undefined => sn.AddAllEquippedItemsToArray(akActor)
...
export const GetAllEnchantments = (akKeywords: Keyword[] = null): Enchantment | null | undefined => sn.GetAllEnchantments(akKeywords)

	//Gets all races from base game + mods, filtered using optional keyword array
export const GetAllRaces = (akKeywords: Keyword[] = null): Race | null | undefined => sn.GetAllRaces(akKeywords)
...
export const GetAllSpells = (akKeywords: Keyword[] = null, abIsPlayable: boolean = false): Spell | null | undefined => sn.GetAllSpells(akKeywords,  abIsPlayable)
...
export const GetActorsByProcessingLevel = (aiLevel: number): Actor | null | undefined => sn.GetActorsByProcessingLevel(aiLevel)

	//Gets all enchantments added by a specified mod/game esm, filtered using optional keyword array.
export const GetAllEnchantmentsInMod = (asModName: string, akKeywords: Keyword[] = null): Enchantment | null | undefined => sn.GetAllEnchantmentsInMod(asModName,  akKeywords)

	//Gets all races added by a specified mod/game esm, filtered using optional keyword array.
export const GetAllRacesInMod = (asModName: string, akKeywords: Keyword[] = null): Race | null | undefined => sn.GetAllRacesInMod(asModName,  akKeywords)

	//Gets all spells added by a specified mod/game esm, filtered using optional keyword array.
export const GetAllSpellsInMod = (asModName: string, akKeywords: Keyword[] = null, abIsPlayable: boolean = false): Spell | null | undefined => sn.GetAllSpellsInMod(asModName,  akKeywords,  abIsPlayable)

	//Gets current cell if in interior/attached cells in exterior/sky cells if in worldspace with no attached cells??
export const GetAttachedCells = (): Cell | null | undefined => sn.GetAttachedCells()
...
export const AddAllItemsToArray = (akRef: ObjectReference | null | undefined, abNoEquipped: boolean = true, abNoFavorited: boolean = false, abNoQuestItem: boolean = false): Form | null | undefined => sn.AddAllItemsToArray(akRef,  abNoEquipped,  abNoFavorited,  abNoQuestItem)
...
export const AddItemsOfTypeToArray = (akRef: ObjectReference | null | undefined, aiFormType: number, abNoEquipped: boolean = true, abNoFavorited: boolean = false, abNoQuestItem: boolean = false): Form | null | undefined => sn.AddItemsOfTypeToArray(akRef,  aiFormType,  abNoEquipped,  abNoFavorited,  abNoQuestItem)
...
export const FindAllReferencesOfFormType = (akRef: ObjectReference | null | undefined, formType: number, afRadius: number): ObjectReference | null | undefined => sn.FindAllReferencesOfFormType(akRef,  formType,  afRadius)
...
export const FindAllReferencesWithKeyword = (akRef: ObjectReference | null | undefined, keywordOrList: Form | null | undefined, afRadius: number, abMatchAll: boolean): ObjectReference | null | undefined => sn.FindAllReferencesWithKeyword(akRef,  keywordOrList,  afRadius,  abMatchAll)
...
export const FindAllReferencesOfType = (akRef: ObjectReference | null | undefined, akFormOrList: Form | null | undefined, afRadius: number): ObjectReference | null | undefined => sn.FindAllReferencesOfType(akRef,  akFormOrList,  afRadius)
...
export const GetActivateChildren = (akRef: ObjectReference | null | undefined): ObjectReference | null | undefined => sn.GetActivateChildren(akRef)
...
export const GetAllArtObjects = (akRef: ObjectReference | null | undefined): Art | null | undefined => sn.GetAllArtObjects(akRef)

	//Get all effect shaders attached to this object.
export const GetAllEffectShaders = (akRef: ObjectReference | null | undefined): EffectShader | null | undefined => sn.GetAllEffectShaders(akRef)
...
export const GetLinkedChildren = (akRef: ObjectReference | null | undefined, akKeyword: Keyword | null | undefined): ObjectReference | null | undefined => sn.GetLinkedChildren(akRef,  akKeyword)
...
export const GetMagicEffectSource = (akRef: ObjectReference | null | undefined, akEffect: MagicEffect | null | undefined): Form | null | undefined => sn.GetMagicEffectSource(akRef,  akEffect)
...
export const GetQuestItems = (akRef: ObjectReference | null | undefined, abNoEquipped: boolean = false, abNoFavorited: boolean = false): Form | null | undefined => sn.GetQuestItems(akRef,  abNoEquipped,  abNoFavorited)

	//Get all aliases containing this ref
export const GetRefAliases = (akRef: ObjectReference | null | undefined): Alias | null | undefined => sn.GetRefAliases(akRef)
...
export const GetPackageIdles = (akPackage: Package | null | undefined): Idle | null | undefined => sn.GetPackageIdles(akPackage)
