...
*/
export const ScanCellObjects = (formType: number, CenterOn: ObjectReference | null, radius: number = 0.0, HasKeyword: Keyword | null = null): (ObjectReference | null)[] => sn.ScanCellObjects(formType, CenterOn, radius, HasKeyword)
